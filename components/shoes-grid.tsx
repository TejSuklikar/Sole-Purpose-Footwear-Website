...
const defaultShoes: Shoe[] = [
  ...
  {
    id: 13,
    name: "Traditional Black Kuffiyeh Dunks",
    price: 160,
    image: "/images/traditional-black-kuffiyeh-dunks.jpeg",
    images: ["/images/traditional-black-kuffiyeh-dunks.jpeg"],
    slug: "traditional-black-kuffiyeh-dunks",
    sizes: allSizes,
    inStockSizes: allSizes,
