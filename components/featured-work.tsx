      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/3] relative rounded-2xl overflow-hidden shadow-2xl bg-neutral-800 border border-neutral-700">
              <Image
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-neutral-400 uppercase tracking-wider">Countries Represented</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-white mb-2">San Francisco</div>
            <div className="text-sm text-neutral-400 uppercase tracking-wider">Based & Made</div>
          </div>
        </div>
      </div>
    </section>
